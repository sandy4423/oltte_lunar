        ...
        <div className="bg-white rounded-lg shadow-sm p-6 space-y-8 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>"비회원"이란 회원가입 절차 없이 휴대폰 번호를 통해 "쇼핑몰"이 제공하는 서비스를 이용하는 자를 말합니다. 본 쇼핑몰은 회원가입 없이 비회원으로 주문하실 수 있습니다.</li>
            </ol>
          </section>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">제13조 (구매안전서비스)</h2>
            <ol className="list-decimal list-inside space-y-2">
              <li>본 쇼핑몰은 전자상거래 등에서의 소비자보호에 관한 법률에 따른 에스크로 서비스를 적용하지 않습니다.</li>
              <li>대신 토스페이먼츠의 전자금융거래 시스템을 통해 안전한 결제가 이루어집니다.</li>
              <li>고객님의 결제 정보는 PG사(토스페이먼츠)를 통해 안전하게 보호됩니다.</li>
            </ol>
          </section>

          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">제14조 (미성년자의 거래)</h2>
            <ol className="list-decimal list-inside space-y-2">
              <li>만 14세 미만 아동은 법정대리인의 동의 없이 거래할 수 없습니다.</li>
              <li>미성년자가 법정대리인의 동의 없이 체결한 계약은 법정대리인이 취소할 수 있습니다.</li>
            </ol>
          </section>
